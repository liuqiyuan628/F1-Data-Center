...
// //f1 individual page data
// function f1PageData(res, rid) {
//   let GrandPrixData = {
//     title: "Race",
//     GrandPrix: null,
//   };
...
//     .then(function (response) {
//       // console.log(response.data);
//       GrandPrixData.GrandPrix = response.data; //store JSON results in f1PageData.shows (previously null)
//       res.render("race", GrandPrixData);
//     })
//     .catch(function (error) {
//       console.log(error);
//     });
...
//     .then(function (response) {
//       // console.log(response.data);
//       weatherPageData.weathers = response.data;
//       res.render("weather", weatherPageData);
//     })
//     .catch(function (error) {
//       console.log(error);
//     });
